...
2. Clone the repository:
   ```bash
   git clone [valid URL][your-repository-name].git
...
While a folder dedicated solely for Shortcut storing purposes is the most convenient, above statement means it will export urls in a folder that may be cluttered with random files.